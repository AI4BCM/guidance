"""Small in-memory retrieval layer for the AI4BCM guidance MCP server."""
...
class Chunk:
    ...
    source_file: str = ""
    # Source terms, from the build's source registry (improvements ticket 05, 2026-09-10).
    # Defaulted like the rest: a corpus built before the registry existed still loads, and
    # the build is where the "no terms, no chunk" rule is enforced.
    source_id: str = ""
    source_edition: str = ""
    licence: str = ""
    citation: str = ""
