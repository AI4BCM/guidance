<!-- meta: unit=levels version=2026.09 cites=1.6,annex-c1,annex-c2 -->
# Where You Stand

## Three ways of working

Before the maturity question, settle which of three things you are using. They fail differently.
...
| Who decides | you | the process and method | the model |
| Results | different each time | comparable | hardly comparable |

The workflow is the middle way, and for most BCM work it is the useful one: a chatbot has no structure, and an agentic system decides things you are accountable for. Comparability is the point. Two BIAs run through the same workflow can be read side by side; two chatbot conversations cannot.
...
Five questions decide whether you can move from 2 to 3, and they are answered with evidence rather than intention:
